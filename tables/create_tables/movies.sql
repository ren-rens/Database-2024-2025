...
values(601, 'Jeffrey Jacob Abrams', '1221 Olympic Boulevard Santa Monica', 72123441);
...
insert into MOVIE(title, year, incolor, studioname, producerc#)
values('Star Trek', 2009, 'Y', 'Paramount', 601);
